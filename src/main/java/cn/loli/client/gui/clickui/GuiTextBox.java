...
public class GuiTextBox extends Gui
{
    ...
    public GuiTextBox(int componentId, HFontRenderer HFontRendererObj, int x, int y, int par5Width, int par6Height)
    {
        this.id = componentId;
        this.HFontRendererInstance = HFontRendererObj;
        this.xPosition = x;
        this.yPosition = y;
    ...
    public void mouseClicked(int p_146192_1_, int p_146192_2_, int p_146192_3_)
    {
        ...
        if (this.isFocused && flag && p_146192_3_ == 0)
        {
            ...
            String s = this.HFontRendererInstance.trimStringToWidth(this.text.substring(this.lineScrollOffset), this.getWidth());
            this.setCursorPosition(this.HFontRendererInstance.trimStringToWidth(s, i).length() + this.lineScrollOffset);
        }
    }
    ...
    public void drawTextBox()
    {
        if (this.getVisible())
        {
            RenderUtils.drawRoundedRect(this.xPosition, this.yPosition,  this.width, this.height,2, new Color(255, 255, 255).getRGB());
            int i = new Color(51, 51, 51).getRGB();
            ...
            if (s.length() > 0)
            {
                ...
                this.HFontRendererInstance.drawString(s1, (float)l, (float)i1, i);
                j1 = l+this.HFontRendererInstance.getStringWidth(s1);
            }
            ...
            {
                j1 = this.HFontRendererInstance.drawString(s.substring(j), (float)j1, (float)i1, i);
            }
            ...
            if (flag1)
            {
                if (flag2)
                {
                    Gui.drawRect(k1, i1 - 1, k1 + 1, i1 + 1 + this.HFontRendererInstance.FONT_HEIGHT, -3092272);
                }
                else
                {
                    this.HFontRendererInstance.drawString("_", (float)k1, (float)i1, i);
                }
            }

            if (k != j)
            {
                int l1 = l + this.HFontRendererInstance.getStringWidth(s.substring(0, k));
                this.drawCursorVertical(k1, i1 - 1, l1 - 1, i1 + 1 + this.HFontRendererInstance.FONT_HEIGHT);
            }
        }
    }
    ...
    public void setSelectionPos(int p_146199_1_)
    {
        ...
        if (this.HFontRendererInstance != null)
        {
            ...
            int j = this.getWidth();
            String s = this.HFontRendererInstance.trimStringToWidth(this.text.substring(this.lineScrollOffset), j);
            int k = s.length() + this.lineScrollOffset;

            if (p_146199_1_ == this.lineScrollOffset)
            {
                this.lineScrollOffset -= this.HFontRendererInstance.trimStringToWidth(this.text, j).length();
            }
