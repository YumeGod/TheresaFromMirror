...
public class InventoryWalk extends Module {
    ...
    public InventoryWalk() {
        ...
        this.keyBindings = new KeyBinding[]{mc.gameSettings.keyBindForward, mc.gameSettings.keyBindRight, mc.gameSettings.keyBindLeft, mc.gameSettings.keyBindBack, mc.gameSettings.keyBindJump};
    }
