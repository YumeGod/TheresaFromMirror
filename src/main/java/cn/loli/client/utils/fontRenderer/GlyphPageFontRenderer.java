...
package cn.loli.client.utils.fontRenderer;
...
public class GlyphPageFontRenderer {
    ...
    public static GlyphPageFontRenderer createFromFile(InputStream inputStream, int size, boolean bold, boolean italic, boolean boldItalic, float yOffset) throws IOException, FontFormatException {
        ...
        GlyphPage regularPage = new GlyphPage(Font.createFont(Font.TRUETYPE_FONT, inputStream).deriveFont(Font.PLAIN, size), true, true);
        ...
        if (bold) {
            boldPage = new GlyphPage(Font.createFont(Font.TRUETYPE_FONT, inputStream).deriveFont(Font.BOLD, size), true, true);
        ...
        if (italic) {
            italicPage = new GlyphPage(Font.createFont(Font.TRUETYPE_FONT, inputStream).deriveFont(Font.ITALIC, size), true, true);
        ...
        if (boldItalic) {
            boldItalicPage = new GlyphPage(Font.createFont(Font.TRUETYPE_FONT, inputStream).deriveFont(Font.BOLD | Font.ITALIC, size), true, true);

            boldItalicPage.generateGlyphPage(chars);
            boldItalicPage.setupTexture();
        }

        GlyphPageFontRenderer glyphPageFontRenderer = new GlyphPageFontRenderer(regularPage, boldPage, italicPage, boldItalicPage);
        glyphPageFontRenderer.yOffset = yOffset;
        return glyphPageFontRenderer;
    }

    public static GlyphPageFontRenderer createFromFile(InputStream inputStream, int size, boolean bold, boolean italic, boolean boldItalic) throws IOException, FontFormatException {
        return createFromFile(inputStream, size, bold, italic, boldItalic, 0);
    }

    public static GlyphPageFontRenderer create(String fontName, int size, boolean bold, boolean italic, boolean boldItalic, float yOffset) {
        char[] chars = new char[256];
    ...
    public static GlyphPageFontRenderer create(String fontName, int size, boolean bold, boolean italic, boolean boldItalic) {
        return create(fontName, size, bold, italic, boldItalic, 0);
    }
