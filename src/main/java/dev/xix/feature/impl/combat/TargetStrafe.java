...
public class TargetStrafe extends AbstractTheresaModule {
    ...
    public TargetStrafe() {
        super("Target Strafe", TheresaModuleCategory.COMBAT);
    }

    private final IEventListener<RenderEvent> onUpdate = e ->
    {
        this.currentTarget = TheresaClient.getInstance().getModuleManager().getModuleOrNull(Aura.class).target;
    ...
    public boolean shouldStrafe() {
        return TheresaClient.getInstance().getModuleManager().getModuleOrNull(TargetStrafe.class).getEnabled() &&
